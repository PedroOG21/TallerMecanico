        ...
        try {
            ...
            switch (evento) {
                ...
                case MODIFICAR_CLIENTE ->
                        resultado = (modelo.modificar(vista.leerClienteDni(), vista.leerNuevoNombre(), vista.leerNuevoTelefono())) ? "El cliente se ha modificado correctamente." : "El cliente no se ha modificado.";
                ...
                case LISTAR_TRABAJOS_CLIENTE ->
                        vista.mostrarTrabajosCliente(modelo.getTrabajos(vista.leerClienteDni()));
                case LISTAR_TRABAJOS_VEHICULO ->
                        vista.mostrarTrabajosVehiculo(modelo.getTrabajos(vista.leerVehiculoMatricula()));
                case SALIR -> terminar();
            }
