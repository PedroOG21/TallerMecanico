...
public class Consola {
    ...
    public static void mostrarCabecera(String mensaje) {
        ...
        String subrayado = "%0" + mensaje.length() + "d%n";
        System.out.println(String.format(subrayado, 0).replace("0", "-"));
    }
   ...
   private static float leerReal(String mensaje) {
    ...
    public static int leerHoras(){
        return leerEntero("Introduce las horas ha añadir: ");
    }
    public  static float leerPrecioMaterial(){
        return leerReal("Introduce el dinero de material ha añadir: ");
    }
